---
title: 'Privacy Policy for the Client Register of Visiosto oy'
---
...
c/o Antti Kivi, Sammonkatu 12 B 28, 00100 HELSINKI
...
The register may also contain data of the controller&rsquo;s business and organisation clients and potential business and organisation clients and personal data of their representatives.
...
The register doesn&rsquo;t contain special categories of personal data, like data concerning health.

## 8. The Sources of Personal Data

The personal data processed is got from the person themselves. The register may also contain the controller&rsquo;s own notes about the persons.

## 9. The Processors of the Data

The personal data may be processed by other controllers on behalf of the controller only if the person in question has given their explicit permission to that during or after giving their personal data to the register. &lsquo;Other controller&rsquo;, in this context, doesn&rsquo;t refer to subcontractors et cetera but to third parties that process personal data for their own purposes.
...
- To the erasure of their data and to be forgotten if:
  - The basis for processing the data is consent and there&rsquo;s no other legal basis for the processing
  - The erasure doesn&rsquo;t conflict with the controller&rsquo;s legal obligations and legitimate interest
...
This privacy policy can be updated for example when legislation or operations change. The privacy policy is last updated on 29/10/2020.
