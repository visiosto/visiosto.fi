...
- Icon indicating that the online store link opens in a new tab.
- Support for creating redirects to external sites from Contentful data.

### Changed

- Icon names for Material icons to be in their on file.
...
- Not being able to toggle the checkbox for the additional agreements in the personal server and domain service registration.
...
- Canonical URLs for the error pages.
...
- Subdomain `www.visiosto.fi` to be the primary domain to follow best practices.
...
- Wrong name of the title variable in the search data for the portfolio pages.

## [0.26.1] - 2021-07-17

### Fixed

- Missing Contentful ID in the portfolio pages search data.
...
- Use regular dashes in the page titles in `head` instead of en-dashes.
- Subtitles of the portfolio pages to monotype.
...
- Colour of the top rule of the first cover on the front page.
...
- Translation keys of the client register titles.
...
[0.26.0]: https://github.com/visiosto/visiosto-website/compare/v0.25.0...v0.26.0
