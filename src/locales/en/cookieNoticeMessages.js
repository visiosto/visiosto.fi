...
export default {
  ...
  cookieNoticeDescription:
    'Our website uses cookies to make your experience with us even sweeter. We use cookies to see what content our visitors are interested in and what we could do better. You can learn more about the cookies we use and manage your settings on the cookie settings page.',
  cookieNoticeAccept: 'Thanks, I accept cookies',
  cookieNoticeReject: 'I’ll check out the cookies and adjust them',
  cookieNoticeSettings: 'Settings',
  ...
  cookieNoticeSave: 'Save and close',
};
