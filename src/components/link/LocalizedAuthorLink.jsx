...
const LocalizedAuthorLink = (props) => {
  ...
  const node = data.allContentfulAuthor.edges.filter(
    ({ node }) =>
  ...
  return <Link {...props} to={`${authorSlug}/${node.slug}`} />;
};

export default LocalizedAuthorLink;
